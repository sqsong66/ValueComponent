package com.sqsong.datepicker.wheel;
...
import com.sqsong.datepicker.R;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    private void computeIndicatorRect() {
        ...
        int indicatorHeadCenterY = mWheelCenterY + mHalfItemHeight + halfSpace;
        int indicatorFootCenterY = mWheelCenterY - mHalfItemHeight - halfSpace;
